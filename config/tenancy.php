...
return [
    ...
    /**
     * Null because tenant ids are slugs we assign ourselves (the client's
     * subdomain), not generated UUIDs. The id becomes the database name.
     */
    'id_generator' => null,
    ...
    /**
     * The domains hosting the central app — the marketing site, the admin
     * back-office, and anything else that is not a client.
     *
     * With subdomain identification these are the domains a tenant subdomain
     * is stripped from: acme.example.test minus example.test gives 'acme'.
     */
    ...
    'database' => [
         ...
         *
         * With slug ids this reads as tenant_acme rather than tenant9f8a4c...,
         * which matters on the day you hand that database to Acme.
         */
        'prefix' => 'tenant_',
        'suffix' => '',
