    ...
    <div class="ov" id="scope3Ov">
        <div class="mdl">
            ...
            <div class="fp" id="scope3P2">
                ...
                <div class="fg" id="scope3FgDept"><label>Department / Cost Center</label><select class="fsl" id="scope3Fdept"><option value="">Select department (optional)...</option>@foreach(departments() as $department)<option value="{{ $department->name }}">{{ $department->name }}</option>@endforeach</select></div>
