...
<div id="content">
    ...
    <!-- Attachments modal -->
    <div class="modal fade" id="scope2AttachmentsModal" tabindex="-1" aria-labelledby="scope2AttachmentsModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="scope2AttachmentsModalLabel"><i class="fas fa-paperclip me-2"></i>Attachments</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body" id="scope2AttachmentsModalBody">
    ...
    <div class="modal fade" id="scope2ViewRecordModal" tabindex="-1" aria-labelledby="scope2ViewRecordModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg scope2-view-modal-dialog">
            <div class="modal-content scope2-view-modal-content">
                <div class="modal-header scope2-view-modal-header">
                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                        <div class="scope2-view-modal-icon"><i class="fas fa-bolt"></i></div>
                        <div>
                            <h5 class="modal-title mb-0" id="scope2ViewRecordModalLabel">Emission Record</h5>
                            <p class="scope2-view-modal-subtitle mb-0">Scope 2 · Purchased energy</p>
                        </div>
                    </div>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body scope2-view-modal-body" id="scope2ViewRecordModalBody">
                    <div class="text-center py-5 scope2-view-loading">
...
<style>
/* View Record modal — Scope 2 */
.scope2-view-modal-dialog { max-width: 560px; }
.scope2-view-modal-content { border: none; border-radius: 16px; overflow: hidden; box-shadow: 0 24px 48px rgba(0,0,0,.15); }
.scope2-view-modal-header {
  background: linear-gradient(135deg, var(--primary-green) 0%, var(--dark-green) 100%);
  color: #fff; padding: 18px 20px; border-bottom: none;
}
.scope2-view-modal-icon {
...
.scope2-view-modal-subtitle { font-size: 0.8rem; opacity: .9; margin-top: 2px; }
.scope2-view-modal-body { padding: 24px; background: var(--gray-50); }
#scope2ViewRecordModal .scope2-view-details-card {
...
#scope2ViewRecordModal .scope2-view-co2e {
...
#scope2ViewRecordModal .scope2-view-co2e .val { font-size: 1.75rem; font-weight: 800; color: var(--primary-green); letter-spacing: -0.02em; }
#scope2ViewRecordModal .scope2-view-co2e .lbl { font-size: 0.7rem; text-transform: uppercase; letter-spacing: .06em; color: var(--gray-600); margin-top: 2px; }
#scope2ViewRecordModal .scope2-view-row { display: flex; padding: 8px 0; border-bottom: 1px solid var(--gray-100); font-size: 0.9rem; }
#scope2ViewRecordModal .scope2-view-row:last-child { border-bottom: none; }
#scope2ViewRecordModal .scope2-view-row .k { color: var(--gray-600); min-width: 120px; flex-shrink: 0; }
#scope2ViewRecordModal .scope2-view-row .v { color: var(--gray-800); font-weight: 500; }
#scope2ViewRecordModal .scope2-view-attachments {
  background: #fff; border-radius: 12px; padding: 16px 18px; border: 1px solid var(--gray-200);
  box-shadow: 0 2px 8px rgba(0,0,0,.04);
}
#scope2ViewRecordModal .scope2-view-attachments .title { font-size: 0.75rem; font-weight: 700; text-transform: uppercase; letter-spacing: .05em; color: var(--gray-600); margin-bottom: 10px; }
#scope2ViewRecordModal .scope2-view-attachment-item {
  display: flex; align-items: center; gap: 10px; padding: 10px 12px; border-radius: 8px;
  background: var(--gray-50); border: 1px solid var(--gray-200); margin-bottom: 8px; font-size: 0.875rem;
  transition: background .15s, border-color .15s;
}
#scope2ViewRecordModal .scope2-view-attachment-item:last-child { margin-bottom: 0; }
#scope2ViewRecordModal .scope2-view-attachment-item:hover { background: #fff; border-color: var(--primary-green); }
#scope2ViewRecordModal .scope2-view-attachment-item a { color: var(--gray-800); text-decoration: none; flex: 1; min-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
#scope2ViewRecordModal .scope2-view-attachment-item a:hover { color: var(--primary-green); }
#scope2ViewRecordModal .scope2-view-attachment-item .open-btn {
...
#scope2ViewRecordModal .scope2-view-attachment-item .open-btn:hover { background: var(--dark-green); color: #fff; }
#scope2ViewRecordModal .scope2-view-no-attach { color: var(--gray-600); font-size: 0.875rem; padding: 8px 0; }
</style>
@endpush
